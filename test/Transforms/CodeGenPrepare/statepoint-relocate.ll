...
entry:
       ...
       %tok = call token (i64, i32, i1 ()*, i32, i32, ...) @llvm.experimental.gc.statepoint.p0f_i1f(i64 0, i32 0, i1 ()* @return_i1, i32 0, i32 0, i32 0, i32 0, i32 0, i32* %base, i32* %ptr)
       %base-new = call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 8)
       %ptr-new = call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 9)
...
entry:
       ...
       %tok = call token (i64, i32, i1 ()*, i32, i32, ...) @llvm.experimental.gc.statepoint.p0f_i1f(i64 0, i32 0, i1 ()* @return_i1, i32 0, i32 0, i32 0, i32 0, i32 0, i32* %base, i32* %ptr, i32* %ptr2)
       %base-new = call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 8)
       %ptr-new = call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 9)
       %ptr2-new = call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 10)
       %ret = load i32, i32* %ptr-new
       ret i32 %ret
}
...
entry:
       ...
       %tok = call token (i64, i32, i1 ()*, i32, i32, ...) @llvm.experimental.gc.statepoint.p0f_i1f(i64 0, i32 0, i1 ()* @return_i1, i32 0, i32 0, i32 0, i32 0, i32 0, [3 x i32]* %base, i32* %ptr)
       %base-new = call [3 x i32]* @llvm.experimental.gc.relocate.p0a3i32(token %tok, i32 8, i32 8)
       %ptr-new = call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 9)
       %ret = load i32, i32* %ptr-new
       ret i32 %ret
}
...
; CHECK: getelementptr i32, i32* %base, i32 15
; CHECK: call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 9)
; CHECK: call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 10)
entry:
       %ptr = getelementptr i32, i32* %base, i32 15
       %ptr2 = getelementptr i32, i32* %base, i32 12
       %tok = call token (i64, i32, i1 ()*, i32, i32, ...) @llvm.experimental.gc.statepoint.p0f_i1f(i64 0, i32 0, i1 ()* @return_i1, i32 0, i32 0, i32 0, i32 0, i32 0, i32* %base, i32* %ptr, i32* %ptr2)
...
entry:
       ...
       %ptr-new = call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 9)
       %base-new = call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 8)
       ; CHECK: %base-new = call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 8)
...
right:
       %ptr-base = call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 8)
       ; CHECK: call i32* @llvm.experimental.gc.relocate.p0i32(token %tok, i32 8, i32 8)
